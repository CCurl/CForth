========================================================================
    STATIC LIBRARY : CForth.Core Project Overview
========================================================================

AppWizard has created this CForth.Core library project for you.

This file contains a summary of what you will find in each of the files that
make up your CForth.Core application.
...
StdAfx.h, StdAfx.cpp
    ...
    named CForth.Core.pch and a precompiled types file named StdAfx.obj.
...
project, including "resource.h", "CForth.Core.rc" and a "CForth.Core.h" that
